...
const restaurant = {
  ...
  // More enhanced object literals, being able to write methods in short hand. No need for the function keyword.
...
const users = [{ name: 'Jason', email: 'someEmail@email.com' }];
...
/*
//////////////////////////////
// The Spread Operator (...) this is on the right hand side of the assignment operator
const arr = [7, 8, 9];
